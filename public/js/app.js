...
class App{
  ...
  /* U P D A T E  */
    ...
    updateBrand(key){
        ...
        let lappy1 = {"Brand":var_brand.value};
        let lappy2 = {"Brand":var_price.value};
        this.cart[key] = lappy1;
        this.cart[key] = lappy2;
        this.cartInventory();
    ...
    for(let index=0; index<this.cart.length; index++){
     html +=`
      <tr id="${idName+index}">
        ...
        <td><button class="btn btn-success" id="action" onclick="component.lappyUpdateInput(${index})">Update</button>&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn btn-danger" id="action" onclick="component.deleteLappy(${index})">Delete</button></td>
      </tr>
    `;
    }
    this.reRender(`${html}`,listShop);
  }
   shoppingListAdd(brand){
    let shopcart = {"Brand":brand};
  ...
  createItem(){
    ...
    let brandy = {"Brand":var_brand.value};
    let pricy = {"Brand":var_price.value};
    this.cart.push(brandy);
    this.cart.push(pricy);
                  ...
                  <img class="media-object img-thumbnail"  width="500"  src="${this.laptop[index].Image} ">
                    ...
                    <div class="section" >
                      <div class="col-xs-12 col-md-12 col-lg-6" id="textBox">
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal" onclick="component.shoppingListAdd('${this.laptop[index].Brand}')">Add to Cart</button>
        ...
        <nav class="navbar navbar-default navbar-fixed-top topnav" role="navigation">
            <div class="container topnav">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand topnav" href="#"> [ LapApp ] </a>
                </div>
